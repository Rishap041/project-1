        ...
        return(
            <div>
                {this.state.isWinemaker && (
                    <div>
                        <Chip label="You are a Product maker" className={classes.chip} />
                    </div>
                )}
                {!this.state.isWinemaker && (
                    <div>
                        <Chip label="You are not a Product maker" className={classes.errorChip} />
                    </div>
                )}
                <div style={{margin: 20}}>
                    <h3>
                    ...
                    <form className={classes.container} noValidate autoComplete="off">
                        ...
                        >
                            ...
                            <Grid item>
                                <TextField
                                    id="standard-name"
                                    label="Product maker Infos"
                                    placeholder="Product maker Infos"
                                    className={classes.textField}
                            ...
                            <Grid item>
                                <TextField
                                    id="standard-name"
                                    label="Product maker Latitude"
                                    placeholder="Product maker Latitude"
                                    className={classes.textField}
                            ...
                            <Grid item>
                                <TextField
                                    id="standard-name"
                                    label="Product maker Longitude"
                                    placeholder="Product maker Longitude"
                                    className={classes.textField}
